<div class="row">
	<div class="col-md-6">
		<img src="{{ $countdown->imageSrc }}" class="img-fluid rounded shadow">
	</div>
	<form class="col-md-6 mx-auto" wire:submit.prevent="save">
		...
		<div class="card shadow">
			<div class="card-header py-3">
				<h6 class="font-weight-bold text-primary m-0">Edit Countdown</h6>
			</div>
			<div class="card-body">
				<div class="form-group row">
					<label class="col-sm-4 col-form-label">Teks</label>
					<div class="col-sm-8">
						<input type="text" class="form-control @error('countdown.text') is-invalid @enderror" wire:model="countdown.text" placeholder="Teks Utama" autofocus>
				...
				<div class="form-group row">
					...
					<div class="col-sm-8">
						<div class="custom-file">
							<label class="custom-file-label">{{ $countdown->image }}</label>
